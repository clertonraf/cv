...
\photoR{2.5cm}{avatar_clerton}
% \photoL{2cm}{avatar_clerton}
\personalinfo{%
  % Not all of these are required!
  % You can add your own with \printinfo{symbol}{detail}
  \email{clertonfilho@gmail.com}
  \phone{+49-0-176-6232-2695}
  % \mailaddress{Firedrichsberger Straße, 4, 10243 Berlin}
  % \homepage{marissamayr.tumblr.com}
  % \twitter{@marissamayer}
  \linkedin{clerton}
  \location{Berlin, Germany}
%   \github{github.com/clertonraf} % I'm just making this up though.
...
\cvevent{Fullstack developer}{Issuu}{Dec 2020 -- Ongoing}{Berlin, Germany}
\begin{itemize}
...
\cvevent{Fullstack developer}{LQ Enterprise}{Jul 2018 -- Nov 2020}{Berlin, Germany}
\begin{itemize}
...
\cvevent{Software Engineer}{Softplan}{May 2017 -- Jun 2018}{Florianopolis, Brazil}
\begin{itemize}
...
\cvevent{Team Leader}{Scopus/Bradesco}{Jul 2016 -- Apr 2017}{Curitiba, Brazil}
\begin{itemize}
...
\cvevent{Consultant Specialist}{HSBC Brazil}{Mar 2013 -- Jun 2016}{Curitiba, Brazil}
...
\cvevent{M.S.\ in Computer Science}{Universidade Federal de Pernambuco}{Mar 2009 -- Mar 2011}{}
...
\cvevent{B.S.\ in Computer Science}{Universidade Federal de Campina Grande}{Mar 2004 -- Feb 2009}{}
